...
# Memory requirement is MN/4 
# M = 1 million
# N = 6571
# 1,642,750,000 bytes aka 1.6 GB. Seems low?

./BOLT-LMM_v2.3/bolt \
    --lmm \
    --bed=genotypes_rsid.bed \
    --bim=genotypes_rsid.bim \
    --fam=genotypes_rsid.fam \
    --phenoFile=pheno.txt \
    --phenoCol=pheno \
    --LDscoresFile=BOLT-LMM_v2.3/tables/LDSCORE.1000G_EUR.tab.gz \
    --modelSnps=ld_pruned_snps_for_pca.prune.in \ 
    --statsFile=mctfr_bolt2.3_all_stats.gz \ 
    --verboseStats